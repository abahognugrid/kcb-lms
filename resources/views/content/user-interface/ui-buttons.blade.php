  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="demo-inline-spacing">
          <button type="button" class="btn rounded-pill btn-dark">Primary</button>
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <small class="text-light fw-medium">Rounded</small>
        <div class="demo-inline-spacing">
          <button type="button" class="btn rounded-pill btn-outline-dark">Primary</button>
        ...
        <div class="row gy-3">
          ...
          <div class="col-lg-4">
            ...
            <div class="demo-inline-spacing">
              ...
              <button type="button" class="btn rounded-pill btn-icon btn-outline-dark">
                <span class="tf-icons bx bx-pie-chart-alt bx-22px"></span>
              </button>
          ...
          <div class="col-xl-6">
            ...
            <div class="demo-vertical-spacing">
              ...
              <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                ...
                <label class="btn btn-outline-dark d-flex flex-column" for="btncheck1"><span class="d-none d-sm-block">Checkbox</span>1 ( pre-checked )</label>

                <input type="checkbox" class="btn-check" id="btncheck2">
                <label class="btn btn-outline-dark d-flex flex-column" for="btncheck2"><span class="d-none d-sm-block">Checkbox</span>2</label>

                <input type="checkbox" class="btn-check" id="btncheck3">
                <label class="btn btn-outline-dark d-flex flex-column" for="btncheck3"><span class="d-none d-sm-block">Checkbox</span>3</label>
              </div>
              <br />
              <!-- Radio -->
