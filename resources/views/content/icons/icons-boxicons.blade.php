...
<div class="d-flex justify-content-center mx-auto gap-4">
  <a href="https://boxicons.com/" target="_blank" class="btn btn-dark">View All Icons</a>
  <a href="{{config('variables.documentation')}}/Icons.html" class="btn btn-dark" target="_blank">How to use icons?</a>
</div>
@endsection
