                ...
                <div class="mb-4">
                    ...
                    @php
                        $groupedPermissions = $permissions->groupBy(function ($permission) {
                            ...
                            return $parts[1] ?? 'Other'; // Group by second word (module)
                        });
                    @endphp
...
@section('scripts')
    <script>
        function toggleAll(checked) {
            // Only toggle checkboxes that are visible
        ...
        document.getElementById('permissionSearch').addEventListener('input', function() {
            ...
            document.querySelectorAll('[id^="group-"]').forEach(group => {
                ...
                // Check each permission inside the group
                ...
                // Show/hide the entire group wrapper
