    ...
    <div class="card-header ">
        ...
        <div class="row">
            ...
            <div class="col-md-9 d-flex justify-content-end">
                <select class="form-select w-50 d-flex align-items-center mx-2" wire:model.live="loanProductId"
                    name="loanProductId">
                ...
                <div class="d-flex align-items-center mx-2 w-50">
                    <input type="checkbox" id="include-written-off-loans" class="form-check-input mx-2"
                        wire:model.change="includeWrittenOffLoans">
                    <label for="include-written-off-loans" class="me-2 form-check-label fs-6">Include Written
                        Off</label>
                </div>
                <x-end-date />
                <x-export-buttons />
            ...
            <table id="report-table" class="table table-bordered table-sm wrap">
                ...
                <tbody>
                    @forelse ($records as $record)
                        <tr>
                            <td>{{ $record->Credit_Account_Reference }}</td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="text-end">
                            <x-money :value="$records->sum('principal_outstanding') +
                                $records->sum('interest_outstanding') +
                                $records->sum('penalty_outstanding')" />
                        </th>
