<div>
    <div class="row">
        <div class="col order-1 mb-6">
            <h6 style="text-align: center; font-weight:bold">Loans Disbursed Age Distribution </h6>
            <div class="row">
        ...
        <div class="col order-1 mb-6">
            <h6 style="text-align: center; font-weight:bold">Loans Paid Back Age Distribution </h6>
            <div class="row">
