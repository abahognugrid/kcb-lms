<div>
    <form wire:submit="store">
        <div class="mb-4">
            ...
            <select class="form-select" id="type" name="partner_id" required wire:model.change='partner_id'>
        ...
        <div class="mb-4">
            ...
            <input type="number" class="form-control" id="Value" name="Value" required wire:model='Value' />
        </div>
        <div class="mb-4">
